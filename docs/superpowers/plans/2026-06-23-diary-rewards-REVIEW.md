...
**Captured (3):**
- `capacity_change` → activity · **Pyramid Plunder** — "Pharaoh's sceptre will now hold up to 10 charges, up from 3"
...
- `capacity_change` → activity · **Pyramid Plunder** — "Pharaoh's sceptre will now hold up to 25 charges, up from 10"
**Omitted (0).**

### Hard — Desert amulet 3 · lamp 15,000 @50
**Captured (7):**
- `capacity_change` → activity · **Pyramid Plunder** — "Pharaoh's sceptre will now hold up to 50 charges, up from 25"
...
- `behavior_toggle` → region · **Kalphite Lair** — "Ropes are now permanently secured once placed at the Kalphite Lair entrance and Queen's Lair"
...
- `behavior_toggle` → region · **Kharidian Desert** · *while-equipped* — "Fully protects against desert heat while worn"
- `capacity_change` → activity · **Pyramid Plunder** — "Pharaoh's sceptre will now hold up to 100 charges, up from 50"
...
- `behavior_toggle` → monster · **Giant Mole** — "Indicates the Giant Mole's location when equipped or held in the inventory in the Mole Hole"
...
- `access` → region · **Rellekka** — "Peer the Seer will act as a bank deposit box"
- `capacity_change` → activity · **Fossegrimen offerings** — "Fossegrimen gives your enchanted lyre an extra charge per offering"
- `fee_waiver` → activity · **Fossegrimen offerings** — "Fossegrimen will imbue your lyre with infinite charges for 800 of each required fish, down from 1,000"
**Omitted (0).**
...
- `fee_waiver` → activity · **Fossegrimen offerings** — "Fossegrimen will imbue your lyre with infinite charges for 600 of each required fish, down from 800"
**Omitted (0).**
...
- `behavior_toggle` → monster · **Aviansie** — "Adamantite bars from aviansie killed in the God Wars Dungeon are now noted"
- `access` → region · **Waterbirth Island** — "Enchanted lyre and its imbued variant can now be played to teleport to Waterbirth Island"
- `access` → skill · **Magic** — "Access to Tan Leather and Recharge Dragonstone from the Lunar spellbook"
- `access` → region · **Troll Stronghold** — "Stony basalt now teleports you on top of the Troll Stronghold, past the rocky shortcut"
- `fee_waiver` → activity · **Fossegrimen offerings** — "Fossegrimen will imbue your lyre with infinite charges for 400 of each required fish, down from 600"
- `access` → skill · **Sailing** — "Access to Bosun Zarah as a crewmate after the completion of Royal Trouble"
**Omitted (0).**
...
- `fee_waiver` → activity · **Fossegrimen offerings** — "Fossegrimen will imbue your lyre with infinite charges for 200 of each required fish, down from 400"
**Omitted (0).**
...
**Captured (5):**
- `behavior_toggle` → region · **Kandarin** — "Acts as a light source when worn or held in the inventory"
...
- `rate_multiplier` +33% → skill · **Crafting** — "The spinning wheel in Seers' Village spins 33% faster"
- `access` → region · **Baxtorian Falls** — "Ropes are now permanently secured at the Baxtorian Falls"
**Omitted (1):**
- ~~No new benefits~~
...
- `access` → region · **Seers' Village** — "Camelot Teleport can now be used to teleport to Seers' Village bank instead"
- `rate_multiplier` +10% → skill · **Ranged** — "10% increased chance to trigger the special effect of enchanted bolts, even in PvP"
**Omitted (0).**
...
- `fee_waiver` → skill · **Smithing** — "Otto Godblessed now turns your Zamorakian spear into a Zamorakian hasta for 150,000 coins, down from 300,000 coins"
**Omitted (0).**
...
- `behavior_toggle` → region · **Mort Myre Swamp** — "Ghasts in the Mort Myre Swamp will ignore you half of the time"
...
- `behavior_toggle` → region · **Morytania** · *while-equipped* — "Acts as a ghostspeak amulet when worn"
...
- `behavior_toggle` → skill · **Prayer** — "causes bones dropped from killed monsters to be automatically buried, granting half the usual Prayer experience"
- `capacity_change` → skill · **Prayer** — "This item is charged with a small amount of ecto-tokens"
...
**Captured (7):**
- `behavior_toggle` → region · **Mort Myre Swamp** · *while-equipped* — "Prevents ghasts from turning your food into rotten food when worn"
...
- `capacity_change` → region · **Barbarian Village** — "The skull sceptre will now hold up to 14 charges, up from 10"
- `capacity_change` → region · **Barbarian Village** — "give an extra bone fragment per component when chiselled"
**Omitted (0).**
...
- `capacity_change` → region · **Barbarian Village** — "The skull sceptre will now hold up to 18 charges, up from 14"
- `capacity_change` → region · **Barbarian Village** — "give two extra bone fragments per component when chiselled"
**Omitted (0).**
...
- `capacity_change` → region · **Barbarian Village** — "The skull sceptre will now hold up to 22 charges, up from 18"
- `capacity_change` → region · **Barbarian Village** — "give three extra bone fragments per component when chiselled"
**Omitted (0).**

### Elite — Varrock armour 4 · lamp 50,000 @70
**Captured (6):**
- `stat_multiplier` → skill · **Mining** · *while-equipped* — "Can be worn in place of a prospector jacket for clue steps, and provides the experience bonus of the full outfit"
...
- `capacity_change` → region · **Barbarian Village** — "The skull sceptre will now hold up to 26 charges, up from 22"
- `capacity_change` → region · **Barbarian Village** — "give four extra bone fragments per component when chiselled"
**Omitted (0).**
...
- `capacity_change` → skill · **Construction** — "The crystal saw will now hold up to 56 charges, up from 28"
**Omitted (1):**
...
- `capacity_change` → region · **Lletya** — "Teleport crystals will now hold up to 5 charges, up from 3"
- `access` → activity · **Pest Control** — "The void knight top and robe can now be upgraded into an elite void top and robe for 200 commendation points each, by speaking to the Elite Void Knight"
...
- `access` → skill · **Crafting** — "you gain the ability to create them yourself (with 78 Crafting and 78 Smithing)"
**Omitted (1):**
...
- `behavior_toggle` → activity · **Chompy bird hunting** — "Chance of receiving a chompy chick when chompy bird hunting, at a rate of 1/500"
- `recurring_resource` → activity · **Chompy bird hunting** — "Rantz offers you 150 ogre arrows for free every day"
- `behavior_toggle` → skill · **Slayer** — "Nieve/Steve now grant as many slayer reward points as Duradel/Kuradal"
- `behavior_toggle` → monster · **Zulrah** — "Resurrect with full health and restored stats once per day when you reach 0 hitpoints against Zulrah"
**Omitted (1):**
...
**Captured (3):**
- `behavior_toggle` → region · **Wilderness** · *while-equipped* — "Always slashes webs successfully"
...
- `access` → activity · **God Wars Dungeon** — "Ecumenical keys can now be sold to the Lesser Fanatic in Edgeville for 61,500 coins each"
...
- `behavior_toggle` → region · **Wilderness** — "select your destination when using Wilderness obelisks, instead of being teleported to a random obelisk"
- `behavior_toggle` → region · **Revenant Caves** — "no longer have a delay of 3 ticks (1.8 seconds) when using a teleport in the Revenant Caves or any of the Wilderness boss caves"
